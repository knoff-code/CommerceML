Отлично! Давайте реализуем **импорт CommerceML в 1С: Управление небольшой фирмой (УНФ)** — актуальную конфигурацию для малого бизнеса, включая розницу и оптовую торговлю.
