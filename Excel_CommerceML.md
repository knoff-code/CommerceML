Ниже приведён **шаблон Excel → CommerceML**, адаптированный под **строительный магазин** с возможностью экспорта данных о товарах, ценах, остатках и поставщиках в формате **CommerceML 2.1**.
